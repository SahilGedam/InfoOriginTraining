...
public class TaskServiceTest {
	...
	public void setUp() {
		...
		Optional<Tasks> task = Optional.of(new Tasks(1, "ocam", true, "2016-02-01"));
	...
	public void saveTaskTest() {
		Tasks taskToSave = new Tasks(65, "ocam", false, "2016-03-01");
	...
	public void updateTaskTest() {
		Long id = 3L;
		Tasks newTaskBody = new Tasks(65, "UpDated Task", false, "2016-03-01");
	...
	public void updateTaskStringForOtherParameters() {
		Long id = 1L;
		Tasks newTaskBody = new Tasks(1L, "UpDated Task", true, "2017-03-01");
		assertEquals("UpDated Task", toDoService.updateTasks(id, newTaskBody).getTask());
	...
	public void getAllTasksTest() {
		when(tasksRepository.findAll()).thenReturn(Stream .of (new Tasks(65,"ocam",false,"2016-02-01"),new Tasks(67,"ocam",true,"2016-03-01")).collect(Collectors.toList()));	
